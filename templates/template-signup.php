    ...
    <div class="flex w-full">
      <div class="w-full lg:w-1/2 flex items-center justify-center lg:justify-end min-h-screen py-16">
        <div class="flex flex-col w-full max-w-2xl px-10 pt-10">
          ...
          <div class="mt-4">
            <p class="italic tracking-tight text-center w-[32rem]">By creating an account and using CinchShare, I agree to CinchShare's <span class="text-secondary mr-2 cursor-pointer">Terms of Service</span>and <span class="ml-2 text-secondary cursor-pointer">Privacy Policy.</span></p>
          </div>
        </div>
      </div>
