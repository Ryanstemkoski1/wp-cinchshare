      ...
      <div class="pt-24 lg:pt-32 flex flex-col xl:flex-row items-center px-3 max-w-max-content mx-auto">
        <div class="w-full flex flex-col items-center xl:items-start xl:w-5/12">
          ...
          <?php if(get_field('pricing_section1_button',$post->ID)) { ?>
            <a href = "<?php echo get_field('pricing_section1_button_link',$post->ID); ?>" type="button" class="false bg-primary hover:scale-[1.03] active:scale-[0.97] text-white px-4 py-2.5 rounded-lg font-bold mt-8 shadow-button-primary px-8"><?php echo get_field('pricing_section1_button',$post->ID); ?></a>
          <?php } ?>
        </div>
