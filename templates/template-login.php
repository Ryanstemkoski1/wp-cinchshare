      ...
      <div class="w-full lg:w-1/2 flex items-center justify-center lg:justify-end py-16">
        <div class="flex flex-col w-full max-w-2xl p-10 login_form">
          <form class=" ">
            ...
            <button class="border-primary text-primary hover:scale-[1.03] active:scale-[0.97] border px-4 py-2.5 rounded-lg font-bold flex items-center justify-center mb-4">
