...
?>  
  ...
  <main id="site-content" role="main">
    ...
    <section class = "max-w-max-content m-auto flex justify-end">
      <div class = "flex border rounded-md w-fit items-center py-2 px-4 learning_center_search" >
        <input type="text" placeholder = "Search something" class="focus:outline-none">
        ...
        <svg width="16" class ="clear rotate-45 hidden" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
