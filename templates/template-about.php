        ...
        <div class="aspect-[16/9] player-wrapper rounded-[2rem] overflow-hidden bg-black">
          <div class="" style="width: 100%; height: 100%;">
            <?php if(get_field('about_section1_video',$post->ID)) { ?>
              <iframe class = "video_cont hidden w-full h-full z-[99999]" src="<?php echo get_field('about_section1_video',$post->ID); ?>"  title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <?php } ?>
