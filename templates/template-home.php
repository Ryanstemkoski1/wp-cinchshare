  ...
  <section class="max-w-max-content mx-auto flex flex-col xl:flex-row items-center xl:items-start px-6 xl:px-0 mt-0 xl:mt-48">
    <div class="max-w-md mt-8 flex flex-col items-center xl:items-start mb-8 xl:mr-16">
      ...
      <?php if(get_field('home_section5_button',$post->ID)) { ?>
        <a href ="<?php echo get_field('home_section5_link',$post->ID); ?>" type="button" class="false bg-primary shadow-button-primary hover:shadow-button-primary-hover hover:scale-[1.03] active:scale-[0.97] text-white px-4 py-2.5 rounded-lg font-bold mt-10 px-8"><?php echo get_field('home_section5_button',$post->ID); ?></a>
      <?php } ?>
