...
?>
  <main id="site-content" role="main">
    <section class="bg-top bg-no-repeat bg-cover fs1_container relative">
      <img class="absolute hidden md:block h-[90vh] object-cover" src="/wp-content/uploads/Features_Section1_bg.svg" style="z-index: -1; width: 100%;">
      <div class="pt-12 max-w-screen-2xl mx-auto flex flex-col items-center px-3">
        ...
        <?php if(get_field('features_section1_button',$post->ID)) { ?>
          <a href = "<?php echo get_field('features_section1_button_link',$post->ID); ?>" type="button" class="false bg-primary shadow-button-primary hover:shadow-button-primary-hover hover:scale-[1.03] active:scale-[0.97] text-white px-4 py-2.5 rounded-lg font-bold mt-8 px-8"><?php echo get_field('features_section1_button',$post->ID); ?></a>
        <?php } ?>
        <?php if(get_field('features_section1_image',$post->ID)) { ?>
          <img class="mt-12 lg:mt-24" src="<?php echo get_field('features_section1_image',$post->ID); ?>" style="max-width: 1172px; width: 100%;">
        <?php } ?>
      </div>
    </section>
      ...
      <div class="w-full flex flex-col-reverse lg:flex-row mt-8">
        <?php 
          if( have_rows('features_section5_group_1') ):
            ...
            <div class="relative lg:w-1/2 lg:pl-4 z-10">
    ...
    <section class="here-cin max-w-max-content mx-auto flex flex-col items-center px-3 mt-20 lg:mt-44">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 justify-center gap-8 md:gap-16 ">
      ...
      <a href = "<?php echo get_field('features_section6_button',$post->ID); ?>" type="button" class="false bg-primary shadow-button-primary hover:shadow-button-primary-hover hover:scale-[1.03] active:scale-[0.97] text-white px-4 py-2.5 rounded-lg font-bold mt-24 mb-24 px-8"><?php echo get_field('features_section6_button',$post->ID); ?></a>
    </section>
